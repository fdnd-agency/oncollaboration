...
export async function load({params}) {
  const webinarURL = `${baseURL}avl_webinars?fields=thumbnail,video,date,title,transcript,description,id,chapters,views,resources.directus_files_id.id,resources.directus_files_id.title,resources.directus_files_id.type,resources.directus_files_id.filesize,speakers.avl_speakers_id.fullname,speakers.avl_speakers_id.slug,speakers.avl_speakers_id.profile_picture,speakers.avl_speakers_id.entitle,categories.avl_categories_id.name&filter[slug][_eq]=${params.slug}`
