<script>
    ...
    import { Select, SearchInput, Button } from "$lib/index.js";
</script>
    ...
    <div class="all-filters">
        <div class="searchbar">
            ...
            <Button
                type="filteren"
                class="search-button"
                style="border-radius: 0px var(--border-radius-small) var(--border-radius-small)
        ...
        <Button type="filteren" class="filteren">Filter webinars</Button>
