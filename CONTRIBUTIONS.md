...
## Branch benaming
Wanneer je een feature wilt aanmaken maak je een branch van de dev en benoem je de branch waarmee je aan de slag gaat. Bijvoorbeeld "view-transition-feature" om verwarring en dubbel werk te voorkomen. Met branch benamingen houd je ook rekening met de kebab-case benaming. 

## Component Library Indeling
